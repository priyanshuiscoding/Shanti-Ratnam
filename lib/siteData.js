...
export const innerPages = [
  ...
  },
  {
    ...
    body:
      `Visit us at Lane No.3 Neha Nagar, Makronia, Sagar-470004, Madhya Pradesh. You can call us on ${CONTACT.callDisplay} and reach us on WhatsApp at ${CONTACT.whatsappDisplay} for consultation booking and treatment guidance.`
  }
];
