...
export const innerPages = [
  ...
  },
  {
    ...
    title: "Treatment",
    intro:
      "Step by step protocols that include diagnosis, therapy mapping, diet guidance, and routine correction.",
    section: "Treatment Workflow",
    body:
      "Use this area to describe detox protocols, rejuvenation therapies, follow up cycles, and expected outcomes."
  },
  {
    slug: "packages",
    title: "Packages",
